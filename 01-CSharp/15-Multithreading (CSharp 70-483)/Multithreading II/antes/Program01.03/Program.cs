...
namespace Program01._03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Tarefa 1: Processar uma faixa de 100 itens em paralelo");
            var loopResult = Parallel.For(0, 99, ( int i, ParallelLoopState state ) => 
            {
                if(i == 74)
                {
                    state.Break();
            ...
            Console.WriteLine("Tarefa 2: Completou sem interrupção? {0}", loopResult.IsCompleted);
            Console.WriteLine("Tarefa 4: Quantos itens foram processados (parcialmente) {0}?", loopResult.LowestBreakIteration);
