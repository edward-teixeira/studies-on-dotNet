...
namespace Listings
{
    class Item_10 //A classe Directorylnfo
    {
        static void XMain(string[] args)
        {
            ...
            localDir.Create();
            if (localDir.Exists) Console.WriteLine("Diretorio criado com sucesso");
            Console.WriteLine(localDir.Attributes);
            Console.WriteLine("Utltimo acesso: {0}", localDir.LastAccessTime);
